...
public class Report {
	...
	//trzeba stworzyc klase XMLReport i JSONReport
	// interface ktory bedzie komunikowal sie z tymi klasami i tą klasą (Report)
	...
	public Report(String string) {
		reportType = string;
		AbstractFactory.handleReport(reportType, this);
